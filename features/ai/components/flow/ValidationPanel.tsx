...
export default function ValidationPanel({ stepIndex, onValidationComplete }: ValidationPanelProps) {
  ...
  return (
    <div className="mt-4 border-t pt-4">
      <h4 className="font-semibold text-gray-800">Step Validation</h4>
          ...
          <>
            ...
            <div className="flex space-x-2">
              <button
                ...
                disabled={validationStatus === 'validating'}
                className="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm transition duration-150 flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <button
                ...
                className="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded text-sm transition duration-150 flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                </svg>
