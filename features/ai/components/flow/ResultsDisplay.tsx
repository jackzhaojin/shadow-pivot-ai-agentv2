...
export default function ResultsDisplay({ designConcepts, evaluationResults, selectedConcept, executionTrace, showTimeline, setShowTimeline }: ResultsDisplayProps) {
  return (
    <>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-8">
          ...
          <ul className="space-y-2 text-gray-700">
            {evaluationResults.map((r, i) => (
              <li key={i} className={`p-2 rounded-md ${selectedConcept === r.concept ? 'bg-emerald-50' : ''}`}>
